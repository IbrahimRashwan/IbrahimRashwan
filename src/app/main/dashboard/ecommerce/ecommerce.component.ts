...
export class EcommerceComponent implements OnInit {
  ...
  // Public
  public data: any;
  public currentUser: ALUserModelGet;
  ...
  constructor(
    ...
    this.isDriver = this._authenticationService.isDriver;
  ...
  ngAfterViewInit() {
    ...
    this._coreConfigService.getConfig().subscribe(config => {
      ...
      if (
        ...
        setTimeout(() => {
          if (this.currentUser.role.type == 'superadmin' || this.currentUser.role.type == 'admin') {
