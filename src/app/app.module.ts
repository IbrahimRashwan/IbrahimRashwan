...
const appRoutes: Routes = [
  ...
  {
    path: 'user',
    loadChildren: () => import('./main/ALUser/ALUser.module').then(m => m.ALUserModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'category',
    loadChildren: () => import('./main/ALCategory/ALCategory.module').then(m => m.ALCategoryModule),
    canActivate: [AuthGuard]
  },
  {
    path: '',
    loadChildren: () => import('./main/ALLogin/ALLogin.module').then(m => m.ALLoginModule),
